const ownerNumber = ["5511977930455@s.whatsapp.net"] 
// mude somente o numero e não tire o @s.whatsapp.net

const OriginalOwner = '5511977930455' 
...
const menumsgimg = (numero, groupname, battery) => {
    return `MENU DO YUSUKE-BOT COM 363 COMANDOS, BATERIA: ${battery}`
}
...
+ 'FN:Meu criador^~^\n' 
+ 'ORG:Miro;\n' 
+ 'TEL;type=CELL;type=VOICE;waid=5511977930455:+55 11 97793-0455\n' 
+ 'END:VCARD'
